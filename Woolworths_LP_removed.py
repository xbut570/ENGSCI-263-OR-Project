...
def load_data():
    ...
    Weekday_Routes = pd.read_csv("Weekday_Routes_removed.csv")
    Weekend_Routes = pd.read_csv("Weekend_Routes_removed.csv")
    storeLocations = pd.read_csv("WoolworthsDemands_removed.csv", usecols=[0])
